...
def array_info(data_array: np.ndarray, label_array: np.ndarray) -> None: 
    ...
    print(f"{sum(x==1 for x in label_array)[0]} of those images have ships in them.")
    print(f"{sum(x==0 for x in label_array)[0]} of those images do NOT have ships in them.")
